...
public class NMD_Chain {
    ...
    public static NMD_Wallet walletA; //Ví A
    public static NMD_Wallet walletB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        walletA = new NMD_Wallet();
        walletB = new NMD_Wallet();
        NMD_Wallet coinbase = new NMD_Wallet();
